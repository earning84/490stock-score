...
`;
    ...
    let timingReason = "";
    if (sum7_17 < 74) {
      if (score7 < 30 && score17 >= 44) {
        if (score42 < 16) {
          timingReason = "향후 폭발적 매출 성장을 견인할 메가트렌드 대형 성장동력은 양호하나 시가총액이 수배로 증가하기는 부족하고, 6개월~1년 내 상승할 단기 가시적 성과 및 투자 타이밍이 부족하여 현시점 기준으로는 투자 시기로 부적합 합니다.";
        } else {
          timingReason = "향후 폭발적 매출 성장을 견인할 메가트렌드 대형 성장동력은 양호하나, 6개월~1년 내 단기 가시적 성과 및 투자 타이밍이 부족하여 현시점 기준으로는 투자 시기로 부적합 합니다.";
        }
      } else if (score17 < 44 && score7 >= 30) {
