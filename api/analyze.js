...
const EXISTING_CRITERIA = [
  { no: 1, max: 40, text: "이 기업은 기인문기정금(기술, 인구, 문화, 기후, 정치, 금융) 변화 중 구체적으로 어떠한 변화에 속해있고 그 변화가 메가 트렌드가 될 것인가?(메가트렌드 조건 1000억달러 시장, CAGR 8%, 20년지속, 특허 건수 및 인용률, 제조업의 15%생산, 고용의 10%, 부가가치 20%등)\n아래 부가설명\n1) 해당 산업의 글로벌 시장규모가 1000억달러 이상 될 것인지\n2) 리서치기관의 리포트등에서 연평균 성장률이 8%이상 지속하는지\n3) 해당 산업의 성장이 20년 이상 가능한지\n4) 한해 산업별 특허 건수 또는 인용률 상위 순위에 어떤 산업이 랭크되어 있는지\n5) 국내 또는 글로벌로 해당 산업의 제조업 생산량이 전체 산업 생산량의 15%이상인지\n6) 국내 또는 글로벌 고용창출의 10%이상 차지하는지\n7) 해당산업이 전체 산업 부가가치의 20%이상인지." },
  { no: 2, max: 40, text: "이 기업의 해당 산업이 글로벌로 필요한 산업인가? 산업 규모가 TAM(최대도달마켓사이즈) or SAM(가능한유효시장)이 1조달러 이상으로 성장할 것인가?(마크마하니)(산업을 확대하지 말것)" },
  { no: 3, max: 16, text: "그 기업이 원래 산업외에 다른 TAM이 큰 산업(3000억달러 이상)으로 진출하여 확장 가능한가?" },
  { no: 4, max: 16, text: "그 사업이 지속 가능한 산업군이냐?" },
  { no: 5, max: 40, text: "해당 산업이 발전하는데 필수적인 핵심 키포인트는 무엇인가? 예로 반도체 산업은  '에너지밴드갭', AI산업은 'Cuda같은 SW기술'등이 산업의 성장 핵심 키포인트잖아. \n어떠한 특성을 기준으로 발전하는가? 해당 기업은 그 핵심 키포인트를 갖췄나?" },
  { no: 6, max: 20, text: "산업 내 투자 수요가 유입되는 가운데, 최근 1~3개월간 스마트 머니(외인·연기금·사모·투신)의 유의미한 순매집(유통시총 1% 이상)이 확인되고 대차·공매도 급증 등 하방 리스크가 배제되어 있는가?(반드시 팩트체크 필수)" },
  { no: 7, max: 40, text: "기업의 사업추진상황·산업·경기사이클상 6개월~1년 내 가시적 성과·투자 타이밍이 기대되는 투자 적기이며, 차트 일봉상 이동평균선 240일선 또는 120일선 위에 위치해 있는가?(이동평균선 역배열 하락 추세 지속 시 20점 이하로 엄격 감점)" },
  { no: 8, max: 20, text: "그 산업의 역사는 어떠했나? 과거 역사와 비교했을때 2년내 돈을 벌 산업의 타이밍인가?" },
  { no: 9, max: 20, text: "해당 산업의 비즈니스 구조, 매출 크기, 매출인식 방식등을 고려했을때 그 산업이 본격 성장하고 있거나 곧 성장할 것인가?" },
  { no: 10, max: 40, text: "글로벌 경쟁력(G). 해당 산업 관련 종사자 누구나 알만한 브랜드 파워나 제품 보유하면 더 좋음. 메가히트, 블록버스터, 브랜드 그 자체가 대표인 그런 제품이나 서비스 수, LTV(고객생애가치)/CAC(고객획득비용)비율등도 고려." },
  { no: 11, max: 60, text: "시장지배력(M). 기술적 해자로 유일 또는 긴 리드타임 격차, 독과점적인 가격결정권, 락인파워(가격경쟁력, 전환비용), 병목현상 해결, 점유율과 지속기간, 장기계약 우위 유무, 표준에 대한 결정권등도 고려" },
  { no: 12, max: 40, text: "신기술력(T). 산업이 발전하면서 좋은 제품을 한,두개가 아닌 지속적으로 꾸준히 좋은 제품을 만들 수 있는 핵심 기술력. 산업리서치 리포트의 TAM 1000억 달러이상의 시장 진출유무, 새로운 산업이나 산업내 다음 단계 진화를 위한 매출액 대비 R&D 경상연구개발비, 특허등록건수 or 특허상용화수등, M&A가능한 자금보유유무등도 고려" },
  { no: 13, max: 40, text: "제품화 능력(C) - capex투자 금액, 생산capa 얼마나 보유, 연구개발부터 상용화까지의 기간 및 대량생산 가능성, 매출총이익률등도 고려" },
  { no: 14, max: 40, text: "경영진 가능성(M) 파괴적 혁신의 아이디어, 기술 리더십, 실행 및 달성능력, 장기적인 목표 제시, 고성장 전략, 비젼, 똘기등 (like 일론머스크)" },
  { no: 15, max: 20, text: "독점적 가능성이 있는가? Market Share를 선점하든, 뺏어올 가능성이 있나?" },
  { no: 16, max: 40, text: "이 기업은 기술, 사업전략, 다른 기업으로 전환비용, 잉여현금흐름, 높은 매출총이익률, 지속적인 반복매출등의 구조적 해자가 있는가?" },
  { no: 17, max: 60, text: "뭔가 미래를 위해 메가트렌드에 속하면서 돈을 많이 벌 수 있는 큰거 한방을 준비하고 있는것이 있나? 매출이 몇배 증가 될 정도로 준비하고 있는 한방이 있는가?" },
  { no: 18, max: 20, text: "이 기업이 해당 산업의 Capex단계부터 밸류체인내에서 병목현상을 해결할 수 있을 정도의 핵심 위치에 있는가?" },
  { no: 19, max: 10, text: "그 기업의 고객기업이 글로벌 큰 기업이 많은가? 그리고 고객수가 풍부한가?" },
  { no: 20, max: 16, text: "해당 산업의 초반기에 강했던 기업인가? 본격 성장기가 되고 나서도 강자의 위치를 지속 유지할 수 있나?" },
  { no: 21, max: 20, text: "매출액의 5~10%이상 연구개발비를 꾸준히 쓰고 있는가?" },
  { no: 22, max: 20, text: "과거 돈 잘벌때와 비교해 현재의 매출과 이익이 각각 60%이상 되는가? 과거 매출을 통해 다시 해당 산업의 붐이 왔을때 다시 제대로 벌 수 있을것인가?" },
  { no: 23, max: 16, text: "3년이상 지속적으로 ROE 15%이상이거나 ROIC 10%이상 유지하고 있는가?" },
  { no: 24, max: 2, text: "기업의 매출과 수주가 계절성 또는 싸이클(시클리컬) 특성을 보이는가? 어떠한 계절성 또는 싸이클을 보이는가? 왜 그런것인가? 이러한 계절성 및 싸이클 특성을 고려하여 어떤 투자 전략을 쓸것인가?" },
  { no: 25, max: 20, text: "영업이익이 증가하고 있는가? 매출이 증가해서 영업이익이 증가하고 있는가? " },
  { no: 26, max: 10, text: "영업이익외 금융수익, 기타수익등의 이익 요소도 증가하고 있나?" },
  { no: 27, max: 20, text: "해당기업의 향후 5년동안의 매출 및 영업이익의 연평균 성장률이 각각 15%이상 되는가?" },
  { no: 28, max: 10, text: "주요비용이 감소하는 추이인가?" },
  { no: 29, max: 4, text: "감가상각비가 유지되고 있거나 감소하고 있는가?" },
  { no: 30, max: 24, text: "최근 연간·분기 실측 재무제표 기반 듀퐁ROE 분석상 순이익률과 자산회전율(수치 직접 기재)이 우수한 수준인가? (ROE 10% 미만 시 8점 이하 채점)" },
  { no: 31, max: 4, text: "재고자산이 과도하게 많이 있는것은 아닌가? 재고자산회전율이 4~6이하인가?" },
  { no: 32, max: 4, text: "매출이 늘고 있는것도 아닌데 재고자산회전율이 낮아지고 있나?" },
  { no: 33, max: 4, text: "재고자산 많아도 재공품이 많은지 반제품이 많은지?(재공품은 바로 판매 안됨) 조선/방산/반도체/디스플레이/바이오/제약등의 수주산업이라 재공품이 많은지?" },
  { no: 34, max: 10, text: "최신 공시 기준 순차입금비율[순차입금(총차입금-현금성자산) / 자기자본]을 정량 계산하여 20% 이하 수준을 충족하고 있는가?" },
  { no: 35, max: 2, text: "이연법인세부채가 많은지 이연법인세자산이 많은지?(이법자가 많으면 내년에 세금 덜낸다)" },
  { no: 36, max: 20, text: "이 기업의 현금성자산, 이익잉여금, 재무 및 지분상태을 고려하였을때 자사주(EB), CB, BW, 차입, 증자등의 자금 조달을 할 필요가 없는가?" },
  { no: 37, max: 10, text: "CAPEX 규모를 고려하여도 유동비율과 당좌비율이 양호하거나 높은가?" },
  { no: 38, max: 16, text: "현재의 시가총액 만큼의 사업규모를 가졌는가? \n(1000억->5000억->1조->10조->50조->100조 각 단계의 규모가 있다. 그 규모만큼 이 기업이 성장 할 수 있는 가능성을 가졌는지)" },
  { no: 39, max: 20, text: "연결·별도 실적(컨센서스 포함) 대비 시가총액의 밸류에이션이 적정하며, 최근 1~3개월간 컨센서스(영업이익·EPS) 상향 및 어닝 서프라이즈 또는 목표주가 상향 추세가 유지되고 있는가?" },
  { no: 40, max: 16, text: "해당기업의 현재 시가총액을 고려했을때, 이기업의 종속기업/관계기업까지 고려했을때 가치가 저평가인가?" },
  { no: 41, max: 20, text: "글로벌 Peer 기업들과 비교하였을때 현재 해당기업의 시가총액이 저평가인가? Peer들의 PER, PSR도 비교했을때 현재 이 기업이 적정한 value인가?" },
  { no: 42, max: 20, text: "이 기업의 산업TAM, SAM, 사업확장성, 향후 매출, 이익, 판매·공급계약등을 감안했을때 장기적으로 현재 시가총액의 3배이상 기업가치가 커질 수 있나?" },
  { no: 43, max: 10, text: "지분 구조가 주가 부양에 유리한 지분 구성으로 되어 있나? (오너가 가족 구성원이 지분을 조금씩 골고루 갖고 있으면 주가 부양 가능성 있음)\n(증여 or 상속문제로 주가 부양 가능성이 낮은건 아닌가? 증여나 상속이 임박해 있으면 세금 문제로 증여/상속 마무리 될때가지 주가 상승 가능성 낮다)" },
  { no: 44, max: 40, text: "이 기업의 valuation인 DCF와 RIM(Residual Income Model) 값은 각각 얼마인가? 제일 먼저 컨센서스 잠정실적 있으면 있는대로 모두 먼저 필수 적용.(ex. 향후 3년치). 없으면 자체 데이터." }
];
...
const NEWBORN_CRITERIA = [
  ...
  { no: 20, max: 16, text: "해당 산업의 초반기에 강했던 기업인가? 본격 성장기가 되고 나서도 강자의 위치를 지속 유지할 수 있나?" },
  { no: 21, max: 20, text: "매출액의 5~10%이상 연구개발비를 꾸준히 쓰고 있는가?" },
  { no: 22, max: 24, text: "최근 회계연도에서 매출 성장률과 영업이익률(또는 EBITDA률)의 합(Rule of 40)이 40% 이상인가? 최근 회계연도의 연간 사업보고서를 기준으로 1년전과 비교.(분기별 아님)" },
  { no: 23, max: 16, text: "Price to Sales Growth(PSG)를 계산하여 1주 가격/(1주당 매출 x 매출 성장률)의 값이 1 미만인가? PSR/매출성장률. %는 수치 그대로 나누기. 최근 회계연도의 연간 사업보고서를 기준으로 1년전과 비교.(분기별 아님)" },
  { no: 24, max: 2, text: "기업의 매출과 수주가 계절성 또는 싸이클(시클리컬) 특성을 보이는가? 어떠한 계절성 또는 싸이클을 보이는가? 왜 그런것인가? 이러한 계절성 및 싸이클 특성을 고려하여 어떤 투자 전략을 쓸것인가?" },
  { no: 25, max: 20, text: "영업이익이 증가하고 있는가? 매출이 증가해서 영업이익이 증가하고 있는가? " },
  { no: 26, max: 10, text: "영업이익외 금융수익, 기타수익등의 이익 요소도 증가하고 있나?" },
  { no: 27, max: 20, text: "해당기업의 향후 5년동안의 매출 및 영업이익의 연평균 성장률이 각각 15%이상 되는가?" },
  { no: 28, max: 10, text: "주요비용이 감소하는 추이인가?" },
  { no: 29, max: 4, text: "고객 한명이 평생 가져다주는 이익인 LTV가 그 고객을 데려오는데 드는 비용인 CAC의 3배 이상 되는가?" },
  { no: 30, max: 20, text: "최근 연간·분기 실측 재무제표 기반 듀퐁ROE 분석상 순이익률과 자산회전율(수치 직접 기재)이 우수한 수준인가? (ROE 10% 미만 시 8점 이하 채점)" },
  { no: 31, max: 4, text: "재고자산이 과도하게 많이 있는것은 아닌가? 재고자산회전율이 4~6이하인가?" },
  { no: 32, max: 4, text: "매출이 늘고 있는것도 아닌데 재고자산회전율이 낮아지고 있나?" },
  { no: 33, max: 4, text: "재고자산 많아도 재공품이 많은지 반제품이 많은지?(재공품은 바로 판매 안됨) 조선/방산/반도체/디스플레이/바이오/제약등의 수주산업이라 재공품이 많은지?" },
  { no: 34, max: 10, text: "최신 공시 기준 순차입금비율[순차입금(총차입금-현금성자산) / 자기자본]을 정량 계산하여 20% 이하 수준을 충족하고 있는가?" },
...
오늘 날짜 시점의 미국 기준금리, 채권금리등의 실시간 매크로 요소와 국제 정치나 전쟁같은 지정학적 리스크, 해당 산업 컨센서스등의 환경들을 고려하여 각 항목을 채점해 주십시오.
...
${isMember ? `[4단계: 5대 핵심 영역 리포트 및 종합 투자 의견(memberReport) 및 keyPoint 작성 (매우 중요)]
- keyPoint: 3줄 이내 요약
- memberReport: 유료 전용 리포트를 아래 구성 및 규칙에 맞추어 반드시 충실하게 작성하십시오.
  * 구성 요소:
    ...
    5. risk: 리스크 분석 (항목 1번부터 44번까지 분석 내용 중 핵심 리스크 요인을 반드시 1,000자 내외로 핵심만 날카롭게 서술)
    6. investmentOpinion: 종합 투자 의견 (항목 7번과 17번을 재요약하고, 투자 적격 조건 충족 여부에 따라 실제 투자 결정을 어떻게 바라보아야 할지 '조심스럽게' 최종 제안)
  * 분량 기준: 1~2번, 4~5번 및 종합의견은 각 1,000자 내외, 3번 financial은 2,000자 내외로 분석한 내용을 기반으로 정밀하게 서술하십시오.
  * 작성 규칙 (절대 엄수):
    ...
    6) 단락 여백: 문단 간격이 너무 벌어지지 않도록, 한 단락이 끝나면 빈 줄은 1줄만(\\n\\n) 넣어 지나치게 넓은 여백을 배제하십시오.` : `[4단계: 핵심 포인트(keyPoint) 작성 (memberReport 생성 생략)]
- keyPoint: 3줄 이내 요약
- memberReport: 일반 사용자 모드이므로 5대 핵심 영역 리포트를 절대 작성하지 마시고, 반드시 null 값으로 반환하십시오.`}
...
반환 JSON 규격 (상장 기업인 경우):
{
  ...
  "scores": [
    {"no": 1, "score": 30, "reason": "글로벌 시장점유율 및 정량 수치에 근거한 구체적 평가 사유"},
    ... 44번까지 빠짐없이
  ]
}
`;
    ...
    const score42 = (scoreMap[42] && scoreMap[42].score) || 0;
    ...
    const requiredCoreScore = isNewborn ? 194 : 210;
    let isEligible = false;
    let ruleMatched = "";

    // 1단계: 최소 점수 기준 미달 필터 (절대 컷트라인: 255 -> 510)
    if (totalScore < 510) {
      isEligible = false;
      ruleMatched = "산업 내 시장 경쟁우위, 수익성 및 재무 안정성 등 기업 전반의 기초 체력(펀더멘탈)이 최소 투자 기준(510점)에 미달하여 부적격입니다.";
    ...
    // 제일 마지막 필터: 최종 타이밍/한방(7번+17번+42번) 검증 및 사유 병합 (37 -> 74, 15 -> 30, 22 -> 44, 8 -> 16)
    let timingReason = "";
    if (sum7_17 < 75) {
      if (score7 < 30 && score17 >= 45) {
        if (score42 < 16) {
          timingReason = "향후 폭발적 매출 성장을 견인할 메가트렌드 대형 성장동력은 양호하나 시가총액이 수배(약 3배이상)로 증가하기는 부족하고, 6개월~1년 내 상승할 단기 가시적 성과 및 투자 타이밍이 부족하여 현시점 기준으로는 투자 시기로 부적합 합니다.";
        } else {
          timingReason = "향후 폭발적 매출 성장을 견인할 메가트렌드 대형 성장동력은 양호하나, 6개월~1년 내 단기 가시적 성과 및 투자 타이밍이 부족하여 현시점 기준으로는 투자 시기로 부적합 합니다.";
        }
      } else if (score17 < 45 && score7 >= 30) {
      ...
      timingReason = "향후 폭발적 매출 성장을 견인할 메가트렌드 대형 성장동력은 양호하나, 현재의 시가총액이 수배(약 3배이상)로 증가하기는 부족 합니다.";
      ruleMatched = `${ruleMatched} 다만, ${timingReason}`;
    }
    ...
    const checklist = {
      isNewborn,
      totalScore: { value: totalScore, pass: totalScore >= 510, threshold: ">= 510" },
      sum7_17: { value: sum7_17, pass: sum7_17 >= 74, threshold: ">= 74 (만점 100)" },
